    ...
    try {
        ...
        if (id){
            ...
            if(movie){
                ...
                return NextResponse.json({message : 'Movie not found'}, {status:404}) // sinon film non trouvé
            }
        } else {
...
export async function POST(req: NextRequest) {
    try {
        ...
        return NextResponse.json({ message: 'Could not create movie' }, { status: 500 }); // impossibilité de créer un film 
    }
}
